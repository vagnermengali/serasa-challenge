...
const Seo = ({ title, description }: SeoInterface) => {
  ...
  return (
    <Head>
      ...
      <link rel="fluid-icon" href="./assets/favicon.webp" title="Serasa" />
      <link rel="icon" type="svg+xml" href="./assets/favicon.webp" />
      <meta name="viewport" content="width=device-width, initial-scale=1.0" />
      <title>{title}</title>
      <link rel="shortcut icon" href="./assets/favicon.webp" type="x-icon" />
      <link rel="icon" href="./assets/favicon.webp" sizes="32x32" />
      <link rel="icon" href="./assets/favicon.webp" sizes="48x48" />
      <link rel="icon" href="./assets/favicon.webp" sizes="96x96" />
      <link rel="icon" href="./assets/favicon.webp" sizes="144x144" />
