        ...
        <>
            {showModal && (
                <div>
                    ...
                    <div id="modal" className="fixed max-w-80 md:max-w-full inset-x-1/2 inset-y-1/2 z-30 -translate-x-2/4 -translate-y-2/4 rounded-lg bg-light-solid w-max flex flex-col items-center justify-center py-6 px-12 shadow-lg h-fit">
                        {type === "success" ? (
                            <>
                                <Image src="./assets/favicon.webp" width={60} height={60} alt="Logo" className="contrast-0 mb-5" />
