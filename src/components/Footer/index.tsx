    ...
    return (
        <footer className='bg-zinc-50  mt-auto'>
            <div className="container mx-auto py-4 flex flex-col justify-center items-center gap-2">
                ...
                <DynamicLink href="https://www.serasa.com.br/politicas-do-site" level="p-bold" ariaLabel="Link Footer" className="text-magenta/90" title="Link Footer" >Termos de uso e privacidade</DynamicLink>
            </div>
        </footer>
    );
};
